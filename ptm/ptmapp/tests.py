...
#
#     def setUp(self):
#         self.user = self.client.post(self.registration_url, data={'username':'Billy-Jean',
#                                                                   'password':'barbstraisand%@#'})
#         response = self.client.post(self.get_token_url, data={'username':'Billy-Jean',
#                                                               'password':'barbstraisand%@#'})
