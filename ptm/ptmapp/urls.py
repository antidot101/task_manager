...
from .views import TaskView, TaskUpdateView, UserRegisterView, TaskChangeHistoryVeiw, WelcomeView
...
urlpatterns = [
    ...
    path('tasks/change-history/<int:pk>', TaskChangeHistoryVeiw.as_view(), name='task_history'),
